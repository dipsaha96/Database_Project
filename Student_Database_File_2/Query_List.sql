...
--same level departmental course
SELECT C.COURSE_ID,
       C.COURSE_TITLE,
       D.NAME AS COURSE_BELONGS_TO,
       C.TOTAL_LECTURES,
...
SELECT A.ASSIGNMENT_TITLE AS ASSIGNMENT1_TITLE,
A.SUBMISSION_DATE AS ASSIGNMENT1_SUBMISSION_DATE,
SA.ASSIGNMENT1_MARK,
B.ASSIGNMENT_TITLE AS ASSIGNMENT2_TITLE,
B.SUBMISSION_DATE AS ASSIGNMENT2_SUBMISSION_DATE,
SA.ASSIGNMENT2_MARK
FROM STUDENT_ALL SA
JOIN ASSIGNMENT A ON A.ASSIGNMENT_ID=SA.ASSIGNMENT1_ID
JOIN ASSIGNMENT B ON B.ASSIGNMENT_ID=SA.ASSIGNMENT2_ID
WHERE SA.COURSE_ID=5202
AND SA.STUDENT_ID=2105001;
