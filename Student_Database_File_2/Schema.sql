...
FOREIGN KEY (STUDENT_ID ) REFERENCES STUDENT (STUDENT_ID),
FOREIGN KEY (COURSE_ID ) REFERENCES COURSE(COURSE_ID),
FOREIGN KEY (ASSIGNMENT1_ID ) REFERENCES ASSIGNMENT(ASSIGNMENT_ID),
FOREIGN KEY (ASSIGNMENT2_ID ) REFERENCES ASSIGNMENT(ASSIGNMENT_ID),
FOREIGN KEY (PROJECT_ID ) REFERENCES PROJECT(PROJECT_ID),
FOREIGN KEY (CT1_ID ) REFERENCES CT(CT_ID),
FOREIGN KEY (CT2_ID ) REFERENCES CT(CT_ID),
FOREIGN KEY (TERM_FINAL_ID ) REFERENCES TERM_FINAL(TERM_FINAL_ID)
)
